...
namespace ExpansionKeleCal.Content.StaryArmor
{
	...
	public class StarLeggingsCalE : ModItem
	{
		...
		public static string setNameOverride="幻星元护胫E";
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarLeggingsCalE>()); // 替换为 GaSniperA 的类型  
    recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("MiracleMatter").Type, 1);
    recipe.AddIngredient(ModContent.ItemType<StarLeggingsCalD>(), 1);
