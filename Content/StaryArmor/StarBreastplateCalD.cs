...
namespace ExpansionKeleCal.Content.StaryArmor
{
	...
	public class StarBreastplateCalD : ModItem
	{
		...
		public static string setNameOverride="幻星元甲D";
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarBreastplateCalD>()); // 替换为 GaSniperA 的类型  
    recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("AuricBar").Type, 2);
    recipe.AddIngredient(ModContent.ItemType<StarBreastplateCalC>(), 1);
