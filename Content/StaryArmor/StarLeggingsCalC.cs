...
namespace ExpansionKeleCal.Content.StaryArmor
{
	...
	public class StarLeggingsCalC : ModItem
	{
		...
		public static string setNameOverride="幻星元护胫C";
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarLeggingsCalC>()); // 替换为 GaSniperA 的类型  
    recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("CosmiliteBar").Type, 2);
    recipe.AddIngredient(ModContent.ItemType<StarLeggingsCalB>(), 1);
