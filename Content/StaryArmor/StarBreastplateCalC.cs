...
namespace ExpansionKeleCal.Content.StaryArmor
{
	...
	public class StarBreastplateCalC : ModItem
	{
		...
		public static string setNameOverride="幻星元甲C";
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarBreastplateCalC>()); // 替换为 GaSniperA 的类型  
    recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("CosmiliteBar").Type, 2);
    recipe.AddIngredient(ModContent.ItemType<StarBreastplateCalB>(), 1);
