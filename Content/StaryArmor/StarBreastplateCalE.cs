...
namespace ExpansionKeleCal.Content.StaryArmor
{
	...
	public class StarBreastplateCalE : ModItem
	{
		...
		public static string setNameOverride="幻星元甲E";
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarBreastplateCalE>()); // 替换为 GaSniperA 的类型  
    recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("MiracleMatter").Type, 1);
    recipe.AddIngredient(ModContent.ItemType<StarBreastplateCalD>(), 1);
