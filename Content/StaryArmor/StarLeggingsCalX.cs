...
namespace ExpansionKeleCal.Content.StaryArmor
{
	...
	public class StarLeggingsCalX : ModItem
	{
		...
		public static string setNameOverride="幻星元护胫J";
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarLeggingsCalX>()); // 替换为 GaSniperA 的类型  
    recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("ShadowspecBar").Type, 1);
    recipe.AddIngredient(ModContent.ItemType<StarLeggingsCalE>(), 1);
