...
namespace ExpansionKeleCal.Content.StaryArmor
{
	...
	public class StarLeggingsCalA : ModItem
	{
		...
		public static string setNameOverride="幻星元护胫A";
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarLeggingsCalA>()); // 替换为 GaSniperA 的类型  
    ...
    recipe.AddIngredient(ExpansionKeleCal.expansionkele.Find<ModItem>("StarLeggingsJ").Type, 1);
