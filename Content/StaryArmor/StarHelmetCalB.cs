...
namespace ExpansionKeleCal.Content.StaryArmor
{
	...
	public class StarHelmetCalB : ModItem
	{
		...
		public static string setNameOverride="幻星元盔B";
    	...
    	return head.type == ModContent.ItemType<StarHelmetCalB>() &&
           body.type == ModContent.ItemType<StarBreastplateCalB>() &&
           legs.type == ModContent.ItemType<StarLeggingsCalB>();
}
	...
	{  
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarHelmetCalB>()); // 替换为 GaSniperA 的类型  
    recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("UelibloomBar").Type, 2);
    recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("BloodstoneCore").Type, 2);
    recipe.AddIngredient(ExpansionKeleCal.expansionkele.Find<ModItem>("StarHelmetJ"), 1);
    recipe.AddTile(TileID.LunarCraftingStation);
    recipe.Register(); // 注册配方 
  
    Recipe recipeI = Recipe.Create(ModContent.ItemType<StarHelmetCalB>()); // 替换为 GaSniperA 的类型  
    recipeI.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("UelibloomBar").Type, 1);
    recipeI.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("BloodstoneCore").Type, 1);
    recipeI.AddIngredient(ModContent.ItemType<StarHelmetCalA>(), 1);
