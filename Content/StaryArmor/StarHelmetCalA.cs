...
namespace ExpansionKeleCal.Content.StaryArmor
{
	...
	public class StarHelmetCalA : ModItem
	{
		...
		public static string setNameOverride="幻星元盔A";
    	...
    	return head.type == ModContent.ItemType<StarHelmetCalA>() &&
           body.type == ModContent.ItemType<StarBreastplateCalA>() &&
           legs.type == ModContent.ItemType<StarLeggingsCalA>();
}
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarHelmetCalA>()); // 替换为 GaSniperA 的类型  
