...
namespace ExpansionKeleCal.Content.StaryArmor
{
	...
	public class StarBreastplateCalB : ModItem
	{
		...
		public static string setNameOverride="幻星元甲B";
    ...
    Recipe recipe = Recipe.Create(ModContent.ItemType<StarBreastplateCalB>()); // 替换为 GaSniperA 的类型  
    ...
    Recipe recipeI = Recipe.Create(ModContent.ItemType<StarBreastplateCalB>()); // 替换为 GaSniperA 的类型  
    ...
    recipeI.AddIngredient(ModContent.ItemType<StarBreastplateCalA>(), 1);
