...
{
    public class StarySwordCalD : StarySwordCalAbs
    {
        ...
        // 特定属性
        private new const string setNameOverride="幻星元剑D";

        private const string introduction ="幻星元剑CIX的升级版";
        ...
        public override void AddRecipes()
        {
            ...
            Recipe recipe = Recipe.Create(Type);
            	recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("CosmiliteBar").Type, 6);
	            recipe.AddIngredient(ModContent.ItemType<StarySwordCalCIX>(), 1);
                recipe.AddTile(ExpansionKeleCal.calamity.Find<ModTile>("CosmicAnvil"));//远古操纵机
                recipe.Register();
        }
    }
}
//     public class StarySwordCalD : ModItem
//     {
//          private const int LeftClickDamage = 511;
...
//         private const int constcrit = 27;
//         private const int constrare = 4;
//         private const string setNameOverride="幻星元剑D";
...
//         private int immuningtime=60+10;

//         //private int cooldownTicks = 7;
//         private int BoostDuration;

//          private const int BoostTime=70;

//         private int defenseBoost=90;

//         private int lifeRegenBoost=(int)(16*20);

//         private float speedBoost=0.45f;

//         private float enduranceBoost=0.31f;
...
//             Recipe recipe = Recipe.Create(ModContent.ItemType<StarySwordCalD>()); // 替换为 GaSniperD 的类型  
