    ...
    public class StarySwordCalCIII : StarySwordCalAbs
    {
        ...
        public override void AddRecipes()
        {
            ...
            Recipe recipe = Recipe.Create(Type);
                ...
                recipe.AddIngredient(ModContent.ItemType<StarySwordCalCI>(), 1);
                recipe.AddTile(TileID.LunarCraftingStation);
                recipe.Register();
        }
    }
}
//     public class StarySwordCalCIII : ModItem
//     {
//          private const int LeftClickDamage = 225;
...
//         private const int constcrit = 23;
//         private const int constrare = 4;
//         private const string setNameOverride="幻星元剑CIII";
...
//         private int immuningtime=50+10;
...
//         private int defenseBoost=50;

//         private int lifeRegenBoost=(int)(12*20);

//         private float speedBoost=0.35f;

//         private float enduranceBoost=0.23f;
...
//             Recipe recipe = Recipe.Create(ModContent.ItemType<StarySwordCalCIII>()); // 替换为 GaSniperD 的类型  
// 	recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("DarkPlasma").Type, 1);
//     recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("ArmoredShell").Type, 1);
// 	recipe.AddIngredient(ModContent.ItemType<StarySwordCalCI>(), 1);
//     recipe.AddTile(TileID.LunarCraftingStation);
