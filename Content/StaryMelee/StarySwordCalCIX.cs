...
{
    public class StarySwordCalCIX : StarySwordCalAbs
    {
        public override string LocalizationCategory => "StaryMelee";
        // 基础属性
        public override int BaseDamage => 255;
        ...
        // 特定属性
        private new const string setNameOverride="幻星元剑CIX";

        private const string introduction ="幻星元剑CIII的升级版";
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("UelibloomBar").Type, 8);
            recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("BloodstoneCore").Type, 1);
	        recipe.AddIngredient(ModContent.ItemType<StarySwordCalCIII>(), 1);
            recipe.AddTile(TileID.LunarCraftingStation);
            recipe.Register();
        }
    }
}
//     public class StarySwordCalCIX : ModItem
//     {
//          private const int LeftClickDamage = 256;
...
//         private const string setNameOverride="幻星元剑CIX";
...
//         private int immuningtime=55+10;

//         //private int cooldownTicks = 7;
//         private int BoostDuration;

//          private const int BoostTime=40;

//         private int defenseBoost=60;

//         private int lifeRegenBoost=(int)(14*20);

//         private float speedBoost=0.4f;

//         private float enduranceBoost=0.27f;
...
//             Recipe recipe = Recipe.Create(ModContent.ItemType<StarySwordCalCIX>()); // 替换为 GaSniperD 的类型  
// 	recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("UelibloomBar").Type, 8);
//     recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("BloodstoneCore").Type, 1);
// 	recipe.AddIngredient(ModContent.ItemType<StarySwordCalCIII>(), 1);
//     recipe.AddTile(TileID.LunarCraftingStation);
...
//                 player.endurance += enduranceBoost*2;
