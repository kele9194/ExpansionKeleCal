...
{
    public class StarySwordCalCI : StarySwordCalAbs
    {
        public override string LocalizationCategory => "StaryMelee";
        // 基础属性
        public override int BaseDamage => 196;
        public override int UseTime => 20;
        public override int Rarity => ItemRarityID.Red;
        public override int Crit => 21;
        
        // 特定属性
        private new const string setNameOverride="幻星元剑CI";

        private const string introduction ="幻星元剑B的升级版";
        ...
        public override void AddRecipes()
        {
	        ...
	        recipe.AddIngredient(ModContent.ItemType<StarySwordCalB>(), 1);
...
//     public class StarySwordCalCI : ModItem
//     {
//          private const int LeftClickDamage = 196;
...
//         private const int constcrit = 21;
//         private const int constrare = 4;
//         private const string setNameOverride="幻星元剑CI";
...
//         private int immuningtime=45+10;
...
//         private int defenseBoost=40;

//         private int lifeRegenBoost=(int)(10*20);

//         private float speedBoost=0.3f;

//         private float enduranceBoost=0.19f;
...
//             Recipe recipe = Recipe.Create(ModContent.ItemType<StarySwordCalCI>()); // 替换为 GaSniperD 的类型  
// 	recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("TwistingNether").Type, 1);
// 	recipe.AddIngredient(ModContent.ItemType<StarySwordCalB>(), 1);
//     recipe.AddTile(TileID.LunarCraftingStation);
//     recipe.Register();
