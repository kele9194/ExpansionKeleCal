...
{
    public class StarySwordCalX : StarySwordCalAbs
    {
        public override string LocalizationCategory => "StaryMelee";
        public override int BaseDamage => 3688;
        public override int UseTime => 20;
        public override int Rarity => ExpansionKeleCal.calamity.Find<ModRarity>("HotPink").Type;
        public override int Crit => 35;
        
        // 特定属性
        private new const string setNameOverride="幻星元剑CIII";

        private const string introduction ="幻星元剑CI的升级版";
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("ShadowspecBar").Type, 1);
            recipe.AddIngredient(ModContent.ItemType<StarySwordCalF>(), 1);
            recipe.AddTile(ExpansionKeleCal.calamity.Find<ModTile>("DraedonsForge"));//远古操纵机
            recipe.Register();
        }
    }
}
//     public class StarySwordCalX : ModItem
//     {
//          private const int LeftClickDamage =3688;
...
//         private const int constcrit = 35;
//         private const int constrare = 4;
//         private const string setNameOverride="幻星元剑X";

//         private const string introduction ="幻星元剑F的升级版,是此剑在灾厄的最终升级版";
...
//         private int totalDashingTime=5;

//         private float dashingGravity = 0.0f;

//         private float defaultGravity =0.4f;

//         private int immuningtime=100+10;

//         //private int cooldownTicks = 7;
//         private int BoostDuration;

//          private const int BoostTime=100;

//         private int defenseBoost=150;

//         private int lifeRegenBoost=(int)(24*20);

//         private float speedBoost=0.6f;

//         private float enduranceBoost=0.8f;
...
//     // Terraria.Projectile.NewProjectile(source, position, velocity, lifePercentageProjectileType, (int)(damage*Math.Sqrt(damage/Item.damage)), knockback, player.whoAmI);
...
//             Recipe recipe = Recipe.Create(ModContent.ItemType<StarySwordCalX>()); // 替换为 GaSniperD 的类型  
// 	recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("ShadowspecBar").Type, 1);
// 	recipe.AddIngredient(ModContent.ItemType<StarySwordCalF>(), 1);
//     recipe.AddTile(ExpansionKeleCal.calamity.Find<ModTile>("DraedonsForge"));//远古操纵机
//     recipe.Register();
...
//             int lifePercentageDamage = (int)(target.lifeMax * 0.008);  // 例如，10%生命值
...
//                 player.endurance += enduranceBoost*0.25f;
