...
namespace ExpansionKeleCal.Content.StaryMelee
{
    ...
    public class StarySwordCalE : StarySwordCalAbs
    {
        ...
        public override void AddRecipes()
        {
	        ...
	        recipe.AddIngredient(ModContent.ItemType<StarySwordCalD>(), 1);
            recipe.AddTile(ExpansionKeleCal.calamity.Find<ModTile>("CosmicAnvil"));//远古操纵机
            recipe.Register();
        }
    }
}
//          private const int LeftClickDamage = 621;
...
//         private const int constcrit = 29;
//         private const int constrare = 4;
//         private const string setNameOverride="幻星元剑E";
...
//         private int immuningtime=70+10;

//         //private int cooldownTicks = 7;
//         private int BoostDuration;

//          private const int BoostTime=80;

//         private int defenseBoost=110;

//         private int lifeRegenBoost=(int)(18*20);

//         private float speedBoost=0.5f;

//         private float enduranceBoost=0.4f;
...
//             Recipe recipe = Recipe.Create(ModContent.ItemType<StarySwordCalE>()); // 替换为 GaSniperD 的类型  
// 	recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("AuricBar").Type, 5);
// 	recipe.AddIngredient(ModContent.ItemType<StarySwordCalD>(), 1);
//     recipe.AddTile(ExpansionKeleCal.calamity.Find<ModTile>("CosmicAnvil"));//远古操纵机
//     recipe.Register();
...
//                 player.endurance += enduranceBoost*1.5f;
