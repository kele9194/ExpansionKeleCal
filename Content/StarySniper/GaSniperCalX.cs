...
namespace ExpansionKeleCal.Content.StarySniper
{
    public class GaSniperCalX : GaSniperAbs
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<GaSniperCalF>(), 1);
...
// 	public class GaSniperCalX : ModItem
// 	{// 右键属性
//          private const int LeftClickDamage = 9194;
//         private const float LeftClickKnockBack = 8f;
//         private const float LeftClickShootSpeed = 32f;
//         private const int LeftClickUseTime = 26;

//         private const int LeftClickUseAnimation = LeftClickUseTime;
        

//         private const int constcrit = 66;
//         private const int constrare = 10;

//         private const string setNameOverride="SG幻星元狙击步枪X";
...
//         const double rightClickCoefficient = 4.01;
//         //int rightClickBulletType=ExpansionKeleCal.expansionkele.Find<ModProjectile>("SharkyBulletPlus").Type;

//         double critOverflowCoefficient = 6;
...
//             Item.value = Item.buyPrice(gold: 400); 
//             Item.crit = constcrit;
...
//                 type = ExpansionKeleCal.expansionkele.Find<ModProjectile>("SharkyBulletPlus").Type;
...
// 	{  
//     // 创建 GaSniperA 武器的合成配方  
//     Recipe recipe = Recipe.Create(ModContent.ItemType<GaSniperCalX>()); 
// 	recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("ShadowspecBar").Type, 1);
// 	recipe.AddIngredient(ModContent.ItemType<GaSniperCalF>(), 1);
//     recipe.AddTile(ExpansionKeleCal.calamity.Find<ModTile>("DraedonsForge"));//远古操纵机
//     recipe.Register(); // 注册配方  
...
//             // 添加自定义的 tooltip  
//             TooltipLine line = new TooltipLine(Mod, "GaSniperCalXTooltip", "该狙击步枪CalF型号升级版,也是该枪在灾厄的最终升级版，使用火枪子弹,钨/银子弹时,会转化为高速子弹。");  
//             tooltips.Add(line);  
//         }  
