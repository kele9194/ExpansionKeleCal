...
namespace ExpansionKeleCal.Content.StarySniper
{
    ...
    public class GaSniperCalCIII : GaSniperAbs
    {
        ...
        // 重写基础属性
        public override int BaseDamage => 2739;
...
// 	public class GaSniperCalCIII : ModItem
// 	{// 右键属性
//          private const int LeftClickDamage = 2739;
//         private const float LeftClickKnockBack = 8f;
//         private const float LeftClickShootSpeed = 32f;
//         private const int LeftClickUseTime = 33;
//         private const int LeftClickUseAnimation = LeftClickUseTime;

//         private const int constcrit = 34;
//         private const int constrare = 9;
//         private const string setNameOverride="SG幻星元狙击步枪CIII";
...
//         double critOverflowCoefficient = 2;
...
//             Item.value = Item.buyPrice(gold: 170); 
//             Item.crit = constcrit;
...
// 	{  
//     // 创建 GaSniperA 武器的合成配方  
//     Recipe recipe = Recipe.Create(ModContent.ItemType<GaSniperCalCIII>()); 
// 	recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("DarkPlasma").Type, 1);
//     recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("ArmoredShell").Type, 1);
// 	recipe.AddIngredient(ModContent.ItemType<GaSniperCalCI>(), 1);
//     recipe.AddTile(TileID.LunarCraftingStation);//远古操纵机
...
// 		public override void ModifyTooltips(System.Collections.Generic.List<TooltipLine> tooltips) {  
//             // 添加自定义的 tooltip  
//             TooltipLine line = new TooltipLine(Mod, "GaSniperCalCIIITooltip", "该狙击步枪CalCI型号升级版,使用火枪子弹,钨/银子弹时,会转化为高速子弹。");  
//             tooltips.Add(line);  
//         }  
