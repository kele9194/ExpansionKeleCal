...
namespace ExpansionKeleCal.Content.StarySniper
{
	...
	public class GaSniperCalCI : GaSniperAbs
    {
        ...
        // 重写基础属性
        public override int BaseDamage => 2439;
        public override float KnockBack => 8f;
        public override float ShootSpeed => 32f;
        public override int UseTime => 35;
        public override int Crit => 30;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<GaSniperCalB>(), 1);
...
// 	{  
//     // 创建 GaSniperA 武器的合成配方  
//     Recipe recipe = Recipe.Create(ModContent.ItemType<GaSniperCalCI>()); 
// 	recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("TwistingNether").Type, 1);
// 	recipe.AddIngredient(ModContent.ItemType<GaSniperCalB>(), 1);
//     recipe.AddTile(TileID.LunarCraftingStation);//远古操纵机
//     recipe.Register(); // 注册配方  
...
// 		public override void ModifyTooltips(System.Collections.Generic.List<TooltipLine> tooltips) {  
//             // 添加自定义的 tooltip  
//             TooltipLine line = new TooltipLine(Mod, "GaSniperCalATooltip", 
//             "该狙击步枪CalB型号升级版,是使用火枪子弹,钨/银子弹时,会转化为高速子弹,此后携带该特性，当暴击率超过100%时会额外增加伤害，并且将暴击率设定为100%");  
//             tooltips.Add(line);  
//         }  
