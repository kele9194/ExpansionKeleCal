...
{
    public class GaSniperCalD : GaSniperAbs
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("CosmiliteBar").Type, 7);
            recipe.AddIngredient(ModContent.ItemType<GaSniperCalCIX>(), 1);
...
// 	public class GaSniperCalD : ModItem
// 	{// 右键属性
//          private const int LeftClickDamage = 3210;
//         private const float LeftClickKnockBack = 8f;
//         private const float LeftClickShootSpeed = 32f;
//         private const int LeftClickUseTime = 30;
//         private const int LeftClickUseAnimation = LeftClickUseTime;

//         private const int constcrit = 42;
//         private const int constrare = 10;
//         private const string setNameOverride="SG幻星元狙击步枪D";
...
//         double critOverflowCoefficient = 3;
...
//             Item.value = Item.buyPrice(gold: 230); 
//             Item.crit = constcrit;
...
// 	{  
//     // 创建 GaSniperA 武器的合成配方  
//     Recipe recipe = Recipe.Create(ModContent.ItemType<GaSniperCalD>()); 
// 	recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("CosmiliteBar").Type, 7);
// 	recipe.AddIngredient(ModContent.ItemType<GaSniperCalCIX>(), 1);
//     recipe.AddTile(ExpansionKeleCal.calamity.Find<ModTile>("CosmicAnvil"));//远古操纵机
//     recipe.Register(); // 注册配方  
...
// 		public override void ModifyTooltips(System.Collections.Generic.List<TooltipLine> tooltips) {  
//             // 添加自定义的 tooltip  
//             TooltipLine line = new TooltipLine(Mod, "GaSniperCalDTooltip", "该狙击步枪CalCIX型号升级版,使用火枪子弹,钨/银子弹时,会转化为高速子弹。");  
//             tooltips.Add(line);  
//         }  
