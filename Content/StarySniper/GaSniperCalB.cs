...
{
    public class GaSniperCalB : GaSniperAbs
    {
        ...
        // 重写基础属性
        public override int BaseDamage => 1665;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<GaSniperCalA>(), 1);
...
// 	{  
//     // 创建 GaSniperA 武器的合成配方  
//     Recipe recipe = Recipe.Create(ModContent.ItemType<GaSniperCalB>()); 
// 	recipe.AddIngredient(ExpansionKeleCal.calamity.Find<ModItem>("ProfanedCore").Type, 1);
// 	recipe.AddIngredient(ModContent.ItemType<GaSniperCalA>(), 1);
//     recipe.AddTile(TileID.LunarCraftingStation);//远古操纵机
//     recipe.Register(); // 注册配方  
...
// 		public override void ModifyTooltips(System.Collections.Generic.List<TooltipLine> tooltips) {  
//             // 添加自定义的 tooltip  
//             TooltipLine line = new TooltipLine(Mod, "GaSniperCalBTooltip", "该狙击步枪灾厄/星辰型号A升级版,使用火枪子弹,钨/银子弹时,会转化为高速子弹。");  
//             tooltips.Add(line);  
//         }  
